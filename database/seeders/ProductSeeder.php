...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::statement("
            ...
            (4, 'Vintage Round Eyeglasses', 'Classic round eyeglasses for a retro look.', 'eyeglasses', 59.99, 'images/eyeglasses5.jpg', 0, 1),
            ...
            (7, 'Coexist Outdoor Glasses', 'Ideal for outdoor activities with polarized lenses for glare reduction.', 'eyeglasses', 89.99, 'images/eyeglasses3.jpg', 1, 0),
